...
For this use-case starting with DbCharmer 1.7.0 we have a feature called forced slave reads.
It consists of a few separate small features that together make it really powerful:
...
We use the plugin in production on Scribd.com with MRI (rubyee) 1.8.7 and Rails 2.2.
